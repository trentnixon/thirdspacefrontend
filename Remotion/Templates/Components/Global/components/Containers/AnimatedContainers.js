...
export const FlatColorRevealHorizontal = ({
	Duration,
	RESOLUTION,
	DATA,
	children,
	...
	return (
		<AnimateElement
			...
			ease="Smooth"
		>
			<FlatColorContainer style={containerStyle}>{children}</FlatColorContainer>
		</AnimateElement>
	);
};

export const FlatColorRevealHorizontalFullScreen = ({
	Duration,
	RESOLUTION,
	DATA,
	children,
