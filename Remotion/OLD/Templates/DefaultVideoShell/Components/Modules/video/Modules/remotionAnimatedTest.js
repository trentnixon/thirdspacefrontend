...
const getAnimationState = (frame) => {
  return Math.min(Math.floor(frame / STATE_DURATION), 3);
};

export const AnimatedCodeExamples = () => {
...
const CodeLine = (props) => <pre>{props.text}</pre>;
const HelloWorld = () => <div className="text-5xl font-bold">Hello World!</div>;